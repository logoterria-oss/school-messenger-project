...
export const LoginScreen = ({ onLogin }: LoginScreenProps) => {
  ...
  if (!selectedRole) {
    return (
      <div className="h-screen overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10 flex items-center justify-center p-4 max-lg:p-4 relative">
        <FloatingDecor />
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10 flex flex-col items-center justify-center p-4 relative">
      <FloatingDecor />
      {isLoggingIn && (
